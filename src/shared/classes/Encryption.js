...
export default class Encryption {
  ...
  static getEncrypted(data) {
    ...
    return CryptoJS.AES.encrypt(JSON.stringify(data), Encryption.KEY, {
      format: Encryption.CryptoJSAesJson
    }).toString();
  }
